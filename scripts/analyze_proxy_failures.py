...
def render_sample_card(
    ...
    metadata = [
        ...
        ("expression", sample.get("expression_proxy", "")),
        ...
        ("event", f"{sample.get('event_id', '')} {sample.get('event_status', '')} conf={sample.get('event_confidence', '')}"),
        ("event target", f"{sample.get('event_target_type', '')} / {sample.get('event_target_id', '')} / {sample.get('event_target_global_person_id', '')}"),
